...
void CFiguras::skybox(float largo, float altura, float profundidad, GLuint text, GLuint text1, GLuint text2, GLuint text3)  //Funcion creacion cielo
{
...
void CFiguras::skybox3 (float altura, float largo, float profundidad, GLuint text)  //Funcion creacion prisma
{
...
void CFiguras::prisma (float altura, float largo, float profundidad, GLuint text, GLuint text2, GLuint text3)  //Funcion creacion prisma
{
...
void CFiguras::prismaBanoCompartido(float largo, float altura, float profundidad, GLuint izquierda, GLuint derecha, GLuint arriba, GLuint abajo, GLuint frente, GLuint atras)  //Funcion creacion prisma
{
	...
	glBindTexture(GL_TEXTURE_2D, atras);
	glBegin(GL_POLYGON);	//Back
	glNormal3f(0.0f, 0.0f, -1.0f);
	glTexCoord2f(0.0f, 1.0f); glVertex3fv(vertice[6]);
	glTexCoord2f(1.0f, 1.0f); glVertex3fv(vertice[5]);
	...
	glBindTexture(GL_TEXTURE_2D, abajo);
	glBegin(GL_POLYGON);  //Bottom
	glNormal3f(0.0f, -1.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(1.0f, 0.0f); glVertex3fv(vertice[1]);
...
void CFiguras::prisma_gen(float altura, float largo, float profundidad, GLuint text, GLuint text2)  //Funcion creacion prisma
{
