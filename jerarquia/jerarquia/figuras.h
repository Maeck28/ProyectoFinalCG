...
class CFiguras
{
	...
	void skybox(float altura, float largo, float profundidad, GLuint text, GLuint text1, GLuint text2, GLuint text3);	//Funcion creacion cielo
	void skybox2 (float altura, float largo, float profundidad, GLuint text);
	void skybox3 (float altura, float largo, float profundidad, GLuint text);
